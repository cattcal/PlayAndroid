...
import cn.hujw.demo.ui.dialog.UpdateDialog;
import cn.hujw.dialog.AddressDialog;
import cn.hujw.dialog.DateDialog;
import cn.hujw.dialog.InputDialog;
import cn.hujw.dialog.MenuDialog;
import cn.hujw.dialog.MessageDialog;
import cn.hujw.dialog.TimeDialog;
import cn.hujw.dialog.ToastDialog;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_dialog_time:
                ...
                new TimeDialog.Builder(this)
                        ...
                        .setListener(new TimeDialog.OnListener() {
                            ...
                            @Override
                            public void onSelected(Dialog dialog, int hour, int minute, int second) {
            ...
            case R.id.btn_dialog_share:
                ...
                new ShareDialog.Builder(this)
                        ...
                        // 分享描述
                        .setShareDescription("PlayAndroid")
                        // 分享缩略图
                        .setShareLogo("http://img2.imgtn.bdimg.com/it/u=331313560,2042471428&fm=26&gp=0.jpg")
                        // 分享链接
